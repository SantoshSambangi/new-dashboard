    ...
    <Box sx={{ display: 'flex', position:"fixed", zIndex: "1"}}>
      <AppBar position="fixed" sx={{ zIndex: (theme) => theme.zIndex.drawer + 1, backgroundColor:"#fff" }}>
        <Toolbar sx={{display:"flex", justifyContent:"space-between"}}>
          <Box component="div" sx={{width:"200px", flexWrap:"wrap"}}>
            <img src='https://s3.ap-south-1.amazonaws.com/greentiger.in-content/brand_icons/logo.png' alt='logo' style={{width:"220px"}}/>
          </Box>
          <Box sx={{color:"black"}}>
